...
DocMeta.setdocmeta!(PawsomeTracker, :DocTestSetup, :(using PawsomeTracker); recursive = true)
...
makedocs(;
    modules = [PawsomeTracker],
    authors = "Yakir Gagnon <12.yakir@gmail.com> and contributors",
    repo = "https://github.com/yakir12/PawsomeTracker.jl/blob/{commit}{path}#{line}",
    sitename = "PawsomeTracker.jl",
    format = Documenter.HTML(; canonical = "https://yakir12.github.io/PawsomeTracker.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/yakir12/PawsomeTracker.jl")
